...
var chunkAZAQFAVC_cjs = require('../chunk-AZAQFAVC.cjs');
...
var RawInspector = React14.forwardRef(
  ({ enabled = true, dangerouslyRunInProduction = false }, ref) => {
    ...
    React14.useEffect(() => {
      (async () => {
        if (!element) return;
        const fiber = chunkG7KC776P_cjs.getFiberFromHostInstance(element);
        if (!fiber) return;
        const latestFiber = chunkG7KC776P_cjs.getLatestFiber(fiber);
        const source = await chunkAZAQFAVC_cjs.getFiberSource(latestFiber);
    ...
    React14.useEffect(() => {
      const handleMouseMove = (event) => {
        const isActive2 = chunkG7KC776P_cjs.isInstrumentationActive() || chunkG7KC776P_cjs.hasRDTHook();
        if (!isActive2) {
          setIsActive(false);
          return;
        }
        if (!dangerouslyRunInProduction) {
          const rdtHook = chunkG7KC776P_cjs.getRDTHook();
          for (const renderer of rdtHook.renderers.values()) {
            const buildType = chunkG7KC776P_cjs.detectReactBuildType(renderer);
    ...
    return /* @__PURE__ */ React14__default.default.createElement(React14__default.default.Fragment, null, /* @__PURE__ */ React14__default.default.createElement(
      ...
      /* @__PURE__ */ React14__default.default.createElement(
        ...
        /* @__PURE__ */ React14__default.default.createElement(
          ...
          `<${chunkG7KC776P_cjs.getDisplayName(currentFiber.type) || "unknown"}>`
        ),
        /* @__PURE__ */ React14__default.default.createElement(
          "div",
          {
